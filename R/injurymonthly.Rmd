...
#Decision Tree
mtree.1 <- rpart(PedInjurie ~ arterial_slow_zones + enhanced_crossings + speed_humps + left_turn_traffic_calming + leading_pedestrian_interval_signals + street_improvement_projects_corridors + neighborhood_slow_zones, data=d.train, method="class")
plot(mtree.1)
text(mtree.1, pretty = 1)
...
mtree.1 <- rpart(BikeInjuri ~ enhanced_crossings + speed_humps + left_turn_traffic_calming + arterial_slow_zones + signal_timing + street_improvement_projects_corridors + neighborhood_slow_zones, data=d.train, method="class")
plot(mtree.1)
text(mtree.1, pretty = 1)
